...
namespace MyEvenement.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength(255, ErrorMessage = "The firstname must not exceed 255 characters long.")]
            [Display(Name = "Nom")]
            public string Nom { get; set; }
            
            [Required]
            [StringLength(255, ErrorMessage = "The lastname must not exceed 255 characters long.")]
            [Display(Name = "Prenom")]
